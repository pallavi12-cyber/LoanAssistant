...
{
JOptionPane.showConfirmDialog(null, "Invalid or empty Loan Balance entry.\nPlase correct.","Balance Input Error",JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE);
...
{
JOptionPane.showConfirmDialog(null, "Invalid or empty Loan Rate entry.\nPlase correct.","Intrest Input Error",JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE);
...
{
JOptionPane.showConfirmDialog(null, "Invalid or empty Number of Payments entry.\nPlase correct.","Number of Payments Input Error",JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE);
...
{
JOptionPane.showConfirmDialog(null, "Invalid or empty Monthly Payment entry.\nPlase correct.","Payment Input Error",JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE);
